...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'MogaNet training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=16, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='moganet_tiny', type=str, metavar='MODEL',
                        choices=['moganet_base', 'moganet_tiny', 'moganet_large', 'moganet_small', \
                                 'moganet_xtiny', 'moganet_xlarge', 'moganet_tiny_sz256'],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'MogaNet training and evaluation script', parents=[get_args_parser()])
