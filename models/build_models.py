...
@register_model
def moganet_xtiny(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def moganet_tiny(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def moganet_tiny_sz256(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = MogaNet(arch='tiny', **kwargs)
    # model.default_cfg = default_cfgs['moganet_t']
    if pretrained:
...
@register_model
def moganet_small(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def moganet_base(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def moganet_large(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def moganet_xlarge(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
